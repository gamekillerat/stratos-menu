...
//Usage of Globals: *ScriptGlobal(your index).Add(your offset).As<int*>() = // your value
namespace Big
{
	namespace Memory
	{
	...
	public:
		...
		inline static bool m_VehicleGodMode{ false };
		inline static bool m_FreezeEvent{ false };
		inline static bool m_KickEvent{ false };
		inline static bool m_ReportBlock{ true };

		inline static std::size_t CayoPericoListPos = 0;
		inline static std::size_t SummerSpecialListPos = 0;
		inline static std::size_t DiamondCasinoAndResortListPos = 0;
		inline static std::size_t TheDiamondCasinoHeistListPos = 0;
		inline static std::size_t ArenaWarListPos = 0;
		inline static std::size_t AfterHoursListPos = 0;
		inline static std::size_t SouthernSanAndreasSuperSportSeriesListPos = 0;
		inline static std::size_t TheDoomsdayHeistListPos = 0;
		inline static std::size_t SmugglersRunListPos = 0;
		inline static std::size_t GunrunningListPos = 0;
		inline static std::size_t SpecialVehicleCircuitListPos = 0;
		inline static std::size_t ImportExportListPos = 0;
		inline static std::size_t CunningStuntsListPos = 0;
		inline static std::size_t FinanceFelonyListPos = 0;
		inline static std::size_t Jan2016ListPos = 0;
		inline static std::size_t FestiveSurpriseListPos = 0;
		inline static std::size_t NextGenListPos = 0;
		inline static std::size_t LTSListPos = 0;
		inline static std::size_t FlightListPos = 0;
		inline static std::size_t IndependenceListPos = 0;
		inline static std::size_t HipsterListPos = 0;
		inline static std::size_t HighListPos = 0;
		inline static std::size_t BusinessListPos = 0;
		inline static std::size_t MassacreListPos = 0;
		inline static std::size_t BeachListPos = 0;
		inline static std::size_t FestiveSurprise2015ListPos = 0;
		inline static std::size_t ExecutivesListPos = 0;
		inline static std::size_t HalloweenListPos = 0;
		inline static std::size_t LowridersListPos = 0;
		inline static std::size_t Ill1ListPos = 0;
		inline static std::size_t Ill2ListPos = 0;
		inline static std::size_t HeistsListPos = 0;
		inline static std::size_t BeMyValentineListPos = 0;
		inline static std::size_t CustomClassicsListPos = 0;
		inline static std::size_t BikersListPos = 0;

		inline static std::size_t BoatListPos = 0;
		inline static std::size_t CommercialsListPos = 0;
		inline static std::size_t CompactsListPos = 0;
		inline static std::size_t CoupesListPos = 0;
		inline static std::size_t CyclesListPos = 0;
		inline static std::size_t EmergencyListPos = 0;
		inline static std::size_t HelicoptersListPos = 0;
		inline static std::size_t IndustrialListPos = 0;
		inline static std::size_t MilitaryListPos = 0;
		inline static std::size_t MotorCyclesListPos = 0;
		inline static std::size_t MuscleListPos = 0;
		inline static std::size_t OffRoadListPos = 0;
		inline static std::size_t OpenWheelListPos = 0;
		inline static std::size_t PlanesListPos = 0;
		inline static std::size_t SUVListPos = 0;
		inline static std::size_t SedansListPos = 0;
		inline static std::size_t ServiceListPos = 0;
		inline static std::size_t SportsListPos = 0;
		inline static std::size_t SportsClassicListPos = 0;
		inline static std::size_t SuperListPos = 0;
		inline static std::size_t TrailerListPos = 0;
		inline static std::size_t TrainsListPos = 0;
		inline static std::size_t UtilityListPos = 0;
		inline static std::size_t VansListPos = 0;

		inline static std::size_t ModelListPos = 0;
		/*const char* weaponNamesString[] = {
		...
		inline static const char* ImportExport[] = {
	"elegy", "tempesta", "italigtb", "italigtb2", "nero",
		...
		inline static const char* CunningStunts[] = {
	...
	"akula", "barrage", "chernobog", "raiden", "yosemite", "deluxo",
		...
		inline static const char* AfterHours[] = {
		...
		inline static const char* ArenaWar[] = {
	"bruiser", "bruiser2", "bruiser3", "brutus", "brutus2", "brutus3", "cerberus", "cerberus2", "cerberus3", "clique", "deathbike",
		...
		inline static const char* TheDiamondCasinoResort[] = {
		...
		inline static const char* TheDiamondCasinoHeist[] = {
		...
		inline static const char* SpecialVehicleCircuit[] = {
			"gp1", "infernus2", "ruston", "turismo2"
		};

		inline static const char* CayoPerico[] = {
		...
		inline static const char* SummerSpecial[] = {
		...
		inline static const char* Bikers[] = {
		...
		inline static const char* Festive2015[] = {
			"tampa"
		};

		inline static const char* NextGen[] = {
			"blimp2", "blista2", "blista3", "buffalo3", "dodo", "dominator2", "dukes", "dukes2", "gauntlet2",
			"marshall", "stalion", "stalion2", "submersible2"
		};

		inline static const char* LTS[] = {
			"furoregt", "hakuchou", "innovation"
		};

		inline static const char* Flight[] = {
			"besra", "coquette2", "miljet", "swift"
		};

		inline static const char* Independence[] = {
			"monster", "sovereign"
		};

		inline static const char* Hipster[] = {
			"blade", "dubsta3", "glendale", "panto", "pigalle", "rhapsody", "warrener"
		};

		inline static const char* High[] = {
			"huntley", "massacro", "thrust", "zentorno"
		};

		inline static const char* Business[] = {
			"alpha", "jester", "turismor", "vestra"
		};

		inline static const char* Massacre[] = {
			"btype"
		};

		inline static const char* Beach[] = {
		...
		inline static const char* Commercials[] = {
		...
		inline static const char* Compacts[] = {
		...
		inline static const char* Helicopters[] = {
		...
		inline static const char* Industrial[] = {
		...
		inline static const char* Military[] = {
		...
		inline static const char* Motorcycles[] = {
		...
		inline static const char* Muscle[] = {
		...
		inline static const char* OffRoad[] = {
		...
		inline static const char* OpenWheel[] = {
							  "formula", "formula2", "openwheel1", "openwheel2"
		};


		inline static const char* Planes[] = {
		...
		inline static const char* Sedans[] = {
		...
		inline static const char* SportsClassic[] = {
		...
		inline static const char* Super[] = {
		...
		inline static const char* Trailer[] = {
		...
		inline static void RemoveAllWeapons(int player)
		{
			const char* weaponNamesString[] = {
		"weapon_dagger", "weapon_bat", "weapon_bottle", "weapon_crowbar",
		"weapon_unarmed", "weapon_flashlight", "weapon_golfclub", "weapon_hammer",
		...
		"weapon_combatshotgun", "weapon_gadgetpistol"
			...
			{
				auto ent = PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(player);
				Hash weaponHash = Joaat(name);
				__try
				{
					if (ENTITY::DOES_ENTITY_EXIST(ent) && !ENTITY::IS_ENTITY_DEAD(ent, 0))
					{
						WEAPON::REMOVE_WEAPON_FROM_PED(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(player), weaponHash);
						std::this_thread::yield();
					}
				}
				__except (EXCEPTION_EXECUTE_HANDLER)
				{
					g_Logger->Info("Failed to Remove Weapons");
				}
			}
		}

		inline static void GiveAllWeapons(int player)
		{
			const char* weaponNamesString[] = {
		"weapon_dagger", "weapon_bat", "weapon_bottle", "weapon_crowbar",
		"weapon_unarmed", "weapon_flashlight", "weapon_golfclub", "weapon_hammer",
		...
		"weapon_combatshotgun", "weapon_gadgetpistol"
			...
			for (auto name : weaponNamesString)
			{
				...
				__try
				{
					if (ENTITY::DOES_ENTITY_EXIST(ent) && !ENTITY::IS_ENTITY_DEAD(ent, 0))
					{
						WEAPON::GIVE_DELAYED_WEAPON_TO_PED(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(player), weaponHash, 1000, false);
						std::this_thread::yield();
					}
				}
				__except (EXCEPTION_EXECUTE_HANDLER)
				{
					g_Logger->Info("Failed to Give Weapons");
				}
			}
		}

		inline static void MaxAmmo(int player)
		{
			const char* weaponNamesString[] = {
		"weapon_dagger", "weapon_bat", "weapon_bottle", "weapon_crowbar",
		"weapon_unarmed", "weapon_flashlight", "weapon_golfclub", "weapon_hammer",
		...
		"weapon_combatshotgun", "weapon_gadgetpistol"
			...
			for (auto name : weaponNamesString)
			{
				...
				__try
				{
					if (ENTITY::DOES_ENTITY_EXIST(ent) && !ENTITY::IS_ENTITY_DEAD(ent, 0))
					{
						WEAPON::GET_MAX_AMMO_IN_CLIP(PLAYER::GET_PLAYER_PED_SCRIPT_INDEX(player), weaponHash, 1);
						std::this_thread::yield();
					}
				}
				__except (EXCEPTION_EXECUTE_HANDLER)
				{
					g_Logger->Info("Failed to Give Max Ammo");
				}
			}
		}
		
		inline static int host;
		inline static int me;
		inline static int friendo;
		/*inline static int m_Levels[8000] = { 0, 800, 2100, 3800, 6100, 9500, 12500, 16000, 19800, 24000, 28500, 33400, 38700, 44200, 50200, 56400, 63000, 69900, 77100, 84700, 92500, 100700, 109200, 118000, 127100, 136500, 146200,
...
//Unlock All
	...
	private:
		bool m_Initialized{};
		inline static bool m_GodMode{ false };
		inline static bool m_NeverWanted{ false };
		inline static int m_WantedLevel{ 0 };
		inline static bool m_Invisible{ false };
		inline static bool m_TinyPlayer{ false };
		inline static bool m_NoRagdoll{ false };
		inline static bool m_FastRun{ false };
		inline static bool m_UltraRun{ false };
		inline static bool m_FastSwim{ false };
		inline static bool m_SuperJump{ false };
		inline static bool m_FlamingFists{ false };
		inline static bool m_SlowMode{ false };
		inline static bool m_DragonBreath{ false };
		inline static bool m_NoClip{ false };
		inline static bool m_NPCIgnore{ false };
		inline static int m_Opacity{ 255 };
		inline static bool m_Freeze{ false };
		inline static bool m_NoCollision{ false };
		inline static bool m_Ragdoll{ false };
		inline static bool m_DisplayFPS{ false };
		inline static bool m_MobileRadio{ false };
		inline static bool m_OffRadar{ false };
		inline static bool m_FlashRun{ false };
		inline static bool m_ForceField{ false };
		inline static bool m_UndeadOffRadar{ false };
		inline static bool m_FlamingAmmo{ false };
		inline static bool m_ExplosiveAmmo{ false };
		inline static bool m_UnlimitedAmmo{ false };//
		inline static bool m_RapidFire{ false };
		inline static bool m_TeleportGun{ false };
		inline static bool m_OneShotKill{ false };
		inline static bool m_DeleteGun{ false };
		inline static bool m_AirStrikeGun{ false };
		inline static bool m_MolotovGun{ false };
		inline static bool m_FlareGun{ false };
		inline static bool m_SmokeGun{ false };
		inline static bool m_CartoonGun{ false };
		inline static bool m_Antiafk{ false };
		inline static bool m_VehicleDrift{ false };
		inline static bool m_HornBoost{ false };
		inline static bool m_VehicleJump{ false };
		inline static bool m_AutoFix{ false };
		inline static bool m_SeatBelt{ false };
		inline static bool m_ZeroGravity{ false };
		inline static bool m_BoostAndJump{ false };
		inline static bool m_VehParachute{ false };
		inline static int m_RPValue{ 0 };
		inline static bool m_Snow{ false };
		inline static bool m_HeadlightInten{ false };
		inline static bool m_BunkerLoop{ false };
		inline static bool m_OrbitalCooldown{ false };
		inline static bool m_RevealPlayers{ false };
		inline static bool m_FreezePlayer{ false };
		inline static bool m_RPDrop{ false };
		inline static bool m_RPGun{ false };
		inline static bool m_ThermalVision{ false };
		inline static bool m_NightVision{ false };
		inline static bool m_RAdmin{ false };
		inline static bool m_Spectate{ false };
		inline static const char* m_PedModels[] = {
